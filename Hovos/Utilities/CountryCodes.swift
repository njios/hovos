...
//  Hovos
//
//  Created by neeraj joshi on 08/10/20.
...
func getCode(completion:@escaping ((_:String)->())){
    ...
    if  locationManager.location != nil{
        ...
        if error == nil {
            if let address = response?.firstResult(){
                ...
                completion(countryDictionary[codeWithName(for: address.country!)] ?? "")
            }
        }
     }
    }
 ...
 func codeWithName(for fullCountryName : String) -> String {
    let locales : String = ""
